    ...
    <footer className="mt-10 border-t border-border/60 bg-card/60 backdrop-blur">
      <div className="container grid gap-8 py-10 md:grid-cols-[1.3fr_1fr_1fr]">
        <div className="space-y-3">
          <p className="font-display text-xl font-semibold">Pikrchi</p>
          <p className="max-w-md text-sm text-muted-foreground">
            Telegram BOOST va PREMIUM xizmatlari orqali ekspertlar, akademiyalar va bizneslar uchun tezkor o&apos;sish infratuzilmasi.
          </p>
        </div>
        <div>
      ...
      <div className="border-t border-border/60">
        <div className="container py-4 text-xs text-muted-foreground">
          {new Date().getFullYear()} Pikrchi. Barcha huquqlar himoyalangan.
        </div>
      </div>
    </footer>
  );
